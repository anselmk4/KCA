      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 text-zinc-550 dark:text-zinc-400 mb-1">
            <Link href="/instructor" className="hover:text-zinc-900 dark:hover:text-white transition-colors">
              <ArrowLeft className="w-4 h-4 inline mr-1" /> Retour à l&apos;accueil formateur
            </Link>
          </div>
          <h1 className="text-2xl font-bold text-zinc-900 dark:text-white flex items-center gap-2">
            <Bell className="w-6 h-6 text-teal-600" /> Notifications Formateur
          </h1>
        </div>
