  ...
  const services = [
    {
      ...
      title: "Turnkey LMS Hosting",
      desc: "Deploy your online academy in 5 minutes. Benefit from our highly secure video players, interactive lesson systems, and student progress tracking.",
    ...
    },
    {
      ...
      desc: "No need for complicated bank accounts or inaccessible gateways. Collect from your students via Airtel Money, M-Pesa, Orange Money, credit card, or PayPal directly worldwide.",
      bgGlow: "group-hover:shadow-[0_0_25px_rgba(16,185,129,0.15)] group-hover:border-emerald-500/50"
    },
    {
      icon: <ShieldCheck className="h-6 w-6 text-indigo-650 dark:text-indigo-400" />,
      title: "Automated Quizzes & Certificates",
      desc: "Validate your students' learning through our quiz creator and automatically generate tamper-proof, PDF-downloadable digital certificates.",
    ...
    },
    {
      ...
      desc: "Our team helps you structure your training modules, record your videos, and optimize your sales funnels to maximize your revenue internationally.",
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-black mb-6 text-zinc-900 dark:text-white leading-tight">
              Everything to create and monetize your{" "}
              <span className="bg-gradient-to-r from-teal-500 via-teal-450 to-indigo-500 dark:from-teal-400 dark:to-indigo-400 bg-clip-text text-transparent">training courses worldwide.</span>
            </h1>
            <p className="text-base text-zinc-650 dark:text-zinc-400 max-w-2xl mx-auto leading-relaxed">
              Cutting-edge technologies and personalized support to propel your online academy.
            </p>
          </motion.div>
          ...
          >
            {services.map((service, index) => (
              <motion.div 
                ...
                className={`group relative bg-white/40 dark:bg-zinc-950/40 backdrop-blur-md border border-zinc-200 dark:border-zinc-850 rounded-3xl p-8 transition-all duration-300 flex flex-col items-start gap-5 overflow-hidden text-left ${service.bgGlow}`}
              >
                ...
                <h2 className="text-xl font-bold text-zinc-900 dark:text-white group-hover:text-teal-400 transition-colors">{service.title}</h2>
