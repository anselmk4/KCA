...
const integrations = [
  {
    ...
    title: "Mobile Money",
    desc: "Airtel Money, M-Pesa, Orange Money — encaissez en quelques secondes depuis n'importe où.",
  ...
  },
  {
    ...
    desc: "Visa, Mastercard, Stripe et PayPal intégrés nativement pour une portée mondiale.",
  ...
  },
  {
    ...
    desc: "Français, Anglais, Espagnol — EUR, USD, GBP et devises locales supportées.",
  ...
  },
  {
    ...
    desc: "Rejoignez des milliers d'instructeurs et d'apprenants à travers le monde entier.",
    ...
    <section className="py-24 bg-white/40 dark:bg-transparent border-t border-zinc-200 dark:border-zinc-900 text-zinc-900 dark:text-white relative overflow-hidden">
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-6 text-zinc-900 dark:text-white">Optimisé pour le monde entier</h2>
