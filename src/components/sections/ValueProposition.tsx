  ...
  const values = [
    {
      ...
      description: "Encaissez les inscriptions à vos cours via Mobile Money, Cartes bancaires ou PayPal — où que vous soyez dans le monde."
    },
    {
    ...
    },
    {
      ...
      description: "Engagez vos élèves avec des quiz interactifs, des supports téléchargeables et des certificats de réussite automatisés."
    }
  ];
    ...
    <section className="py-24 bg-white/40 dark:bg-zinc-900/30 border-t border-zinc-200 dark:border-zinc-900">
      <div className="container mx-auto px-4 md:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-zinc-900 dark:text-white">Notre Proposition de Valeur</h2>
