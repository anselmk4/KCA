...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-[#030712] text-white pt-28 pb-32 lg:pt-36 lg:pb-44">
          ...
          <div className="lg:col-span-7 text-left space-y-8">
            ...
            <div className="space-y-4 max-w-2xl">
              <motion.p 
                ...
                className="text-lg md:text-xl text-zinc-300 font-semibold"
              >
            ...
            >
              ...
              <Link 
                href="/courses" 
                className="inline-flex items-center justify-center rounded-xl text-sm font-bold transition-all border border-zinc-800 hover:border-zinc-700 bg-zinc-900/50 hover:bg-zinc-900 text-zinc-300 hover:text-white h-14 px-8 w-full sm:w-auto backdrop-blur-sm"
              >
                Voir le catalogue
              </Link>
            </motion.div>
          ...
          <div className="lg:col-span-5 relative w-full aspect-square max-w-[500px] mx-auto lg:max-w-none">
            ...
            <div className="relative w-full h-full flex items-center justify-center">
              ...
              <motion.div 
                ...
                className="relative w-full h-[90%] rounded-3xl overflow-hidden border border-zinc-800 bg-zinc-950/60 backdrop-blur-md shadow-2xl p-6 flex flex-col gap-6"
              >
                {/* Header Mock */}
                <div className="flex items-center justify-between border-b border-zinc-900 pb-4">
                  ...
                  <span className="text-[10px] text-zinc-600 bg-zinc-900/60 px-3 py-1 rounded-full border border-zinc-800/50 font-mono">ansella.app/dashboard</span>
                </div>

                {/* Simulated course creation layout */}
                <div className="flex-1 space-y-4">
                  <div className="h-4 bg-zinc-900 rounded-lg w-1/3" />
                  <div className="h-8 bg-zinc-900/50 rounded-xl w-3/4" />
                  <div className="grid grid-cols-2 gap-3 pt-2">
                    <div className="bg-zinc-900/30 border border-zinc-900 rounded-2xl p-4 space-y-1">
                  ...
                  <div className="border border-zinc-900 rounded-2xl p-4 bg-zinc-900/10 space-y-2 flex items-center justify-between gap-3">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-lg bg-teal-500/10 border border-teal-500/20 flex items-center justify-center">
                        <Play className="w-4 h-4 text-teal-400 fill-teal-400" />
                      </div>
                      <div>
                        <p className="text-xs font-bold">Introduction au Web3</p>
              ...
              <motion.div 
                ...
                className="absolute -top-4 -left-6 bg-zinc-950/80 backdrop-blur-xl border border-zinc-800 rounded-2xl p-4 shadow-xl flex items-center gap-3 max-w-[190px]"
              >
              ...
              <motion.div 
                ...
                className="absolute -bottom-6 -right-6 bg-zinc-950/80 backdrop-blur-xl border border-zinc-800 rounded-2xl p-4 shadow-xl flex items-center gap-3 max-w-[200px]"
              >
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-sm font-black text-white">1,480</p>
                </div>
              </motion.div>
