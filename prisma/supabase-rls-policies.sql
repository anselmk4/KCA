...
-- ==================== USER_ROLES TABLE ====================
-- Allow users to read their own roles (creation and modification restricted to service role / admin APIs)
DO $$
BEGIN
  IF NOT EXISTS (
...
-- Allow students to select their own quiz attempts
DO $$
BEGIN
...
-- Allow students to select their own certificates
DO $$
BEGIN
